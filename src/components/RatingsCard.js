  ...
  return (
    <View style={{width: Dimensions.get('window').width* 0.6, height: Dimensions.get('window').height* 0.13, borderRadius: 25, backgroundColor: '#131313', marginRight: 10,padding: 11}}>
        <View style={{ display:"flex",flexDirection:"row", justifyContent:"space-between" }}>
            <View>
                <Text style={{ color: '#fff', fontSize: 18,paddingLeft:10 }}>Username</Text>
        ...
        <Text style={{paddingLeft:10, color: '#fff',fontSize: 16 }}>Lorem Ipsum is simply dummy text of the printing and typesetting industry</Text>
        <View>
