...
export default function AccountPic() {
  ...
  return (
    ...
    <Image source={{uri:service}} style={{width: Dimensions.get('window').width* 0.3,height: Dimensions.get('window').height* 0.2, borderRadius:25}}/>
  </View>)
}
