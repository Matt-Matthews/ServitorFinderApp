...
export default function CustomInput({icon, placeholder, password, fileInput,setValue,value}) {
  return (
    <View style={{...styles.submainview, display:'flex',flexDirection:'row'}}>
        <Ionicons name={icon} size={20} color='gray' />     
        <TextInput value={value} onChangeText={text=>setValue(text)} placeholderTextColor={"grey"} placeholder={placeholder} style={styles.inputs}></TextInput>
        ...
        {password&&<Icon  
                    ...
                    name={password?"md-eye-off-sharp":"md-eye-sharp"} 
                    type="ionicon" 
                />}
        {
